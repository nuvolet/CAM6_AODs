...
implicit none
public :: modal_aer_opt_readnl, modal_aer_opt_init, modal_aero_sw, modal_aero_lw, binterp, modal_size_parameters, read_water_refindex
! private
save

! ---->>>>>>>>>>>>>>>>>>>>>>>>>> making binterp, modal_size_parameters, read_water_refindex subroutines as public
! public :: modal_aer_opt_readnl, modal_aer_opt_init, modal_aero_sw, modal_aero_lw, binterp, modal_size_parameters, read_water_refindex
   ...
   do m = 1, nmodes
      ...
      do isw = 1, nswbands
         ...
         do k = top_lev, pver
            ...
            ! ------ write cext, cabs and casm in log file
! 			write(iulog,*) 'cext=',cext
! 			write(iulog,*) 'cabs=',cabs
! 			write(iulog,*) 'casm=',casm						
            ...
            do i = 1, ncol !------------ This loop writes values in log file
               ...
               if ((dopaer(i) <= -1.e-10_r8) .or. (dopaer(i) >= 30._r8)) then
                  ...
                  write(iulog,*) ' pext=', pext(i), ' pabs=', pabs(i), ' pasm=', pasm(i) ! --- printing in log file parameterizations
...
!===============================================================================
! Private routines ---- These subroutine have been made public at the beginning of the module
!===============================================================================
